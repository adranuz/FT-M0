...
function esVocal(letra){
  ...
  //verifica que no este vacio o no tenga mas de un caracter
  ...
  // get index by array value
  // si no existe la posicion regresa -1
  if(vocales.indexOf(letra) != -1) return "Es vocal"
}
